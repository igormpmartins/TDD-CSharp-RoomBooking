    ...
    public class RoomBookingServiceTest
    {
        ...
        public void Should_Return_Available_Rooms()
        {
            ...
            using (var context = new RoomBookingAppDbContext(dbOptions))
            {
                ...
                context.Add(new RoomBooking { FullName = "", Email = "", RoomId = 1, Date = date});
                context.Add(new RoomBooking { FullName = "", Email = "", RoomId = 2, Date = date.AddDays(-1)});
        ...
        public void Should_Save_Room_Booking()
        {
            ...
            { 
                RoomId = 1, Date = new DateTime(2021, 06, 09),
                Email = "",
                FullName = ""
            };
